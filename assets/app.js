...
const DICT={en:{
 ...
 'eq-h':'The firm, in its early days.',cvbtn:'View background',pd:'To be defined',rolab:'Attorney',cfund:'Founder',ccext:'Foreign Trade',semb:'Photo pending',
 eqnote:'Some team photos and bios pending delivery by the firm. Titles to be confirmed.',
 'mis-h':'Mission',mis:'Comprehensive, excellent legal counsel, close to each client\'s business.',
 'vis-h':'Vision',vis:'To be the reference firm for investment in the southern peninsula and the Bajío.',
