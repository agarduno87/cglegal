...
function db(): PDO {
  ...
  if (($cfg['driver'] ?? 'sqlite') === 'sqlite') {
    ...
    $pdo->exec("CREATE TABLE IF NOT EXISTS users(id INTEGER PRIMARY KEY AUTOINCREMENT,name TEXT NOT NULL,email TEXT UNIQUE NOT NULL,password_hash TEXT NOT NULL,role TEXT NOT NULL DEFAULT 'cliente',created_at TEXT DEFAULT CURRENT_TIMESTAMP)");
